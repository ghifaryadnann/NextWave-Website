      ...
      <div className="flex h-screen items-center  justify-center">
        <div className="flex flex-col items-center  sm:items-left sm:px-[50px] p-5 h-4/5 w-full ">
          <div className="flex flex-col  justify-center h-full ">
            <div>
              <h1 data-aos = "fade-right" className="text-[40px]">
            ...
            <div className="mt-5 flex flex-col sm:flex-row   ">
              <div>
                <p data-aos="zoom-in" className=" sm:w-4/5 text-gray-600 ">
                ...
                <div className="hidden sm:inline mt-5 sm:w-4/5">
                  <h2 data-aos="zoom-in" className="text-2xl text-blue-500 mt-4">Visi</h2>
                  <p data-aos="zoom-in" className="opacity-80">
                ...
                <div className="hidden sm:block mt-5 sm:w-4/5">
                  <h2 data-aos="zoom-in" className="text-2xl text-purple-500">Misi</h2>
                  <p data-aos="zoom-in" className="opacity-80">
